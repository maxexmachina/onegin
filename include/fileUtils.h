...
//! 
//! @param[in]  text    text_t struct containing the text to write
//! @param[in]  filePath    Relative path to file in which to write the text
//!
//! @return 1 in case of successful operation, 0 otherwise
//!
//! @note The file is opened in "a" mode, lines are appended to the end
//------------------------------------------------------------ 
